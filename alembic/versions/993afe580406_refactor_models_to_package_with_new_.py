...
def upgrade() -> None:
    ...
    # op.create_table('sessions') - Removed as duplicate of 3c60
    ...
    # op.create_table('messages') - Removed as duplicate of 3c60
    ...
    op.add_column('pending_actions', sa.Column('user_id', sa.UUID(), nullable=True))
